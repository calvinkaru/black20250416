...
import simplelogo from '@/simple-logo.png';
...
export default function Login({ status, canResetPassword, version }) {
    ...
    return (
        <GuestLayout>
            ...
            <div className="text-center py-3 text-gray-400 uppercase">Simple POS Version {version} <br></br> Developed by: Simple Solutions </div>
            </div>
